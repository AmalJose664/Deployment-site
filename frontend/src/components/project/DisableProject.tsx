		...
		{isDisabled ? (
				...
				<AlertDialogContent>
					...
					<AlertDialogFooter>
						...
						<AlertDialogAction
							...
							className="border-blue-400 border bg-blue-400 hover:bg-blue-500"
						>
							Enable
						</AlertDialogAction>
					</AlertDialogFooter>
			...
			<AlertDialog>
				...
				<AlertDialogContent>
					...
					<AlertDialogFooter>
						<AlertDialogCancel >Cancel</AlertDialogCancel>
						<AlertDialogAction onClick={() => changeProjectStatus(true)} className="border-red-500 border bg-red-400">Disable</AlertDialogAction>
					</AlertDialogFooter>
				</AlertDialogContent>
			</AlertDialog >
		)}
