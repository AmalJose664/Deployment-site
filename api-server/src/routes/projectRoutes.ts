...
projectRouter.get('/:projectId/deployments',
	authenticateToken,
...
projectRouter.post('/:projectId/deployments',
	authenticateToken,
	validateObjectId("projectId"),
	deploymentController.createDeployment.bind(deploymentController));

projectRouter.get('/:projectId/logs',
	authenticateToken,
	validateObjectId("projectId"),
	logsController.getLogsByProject.bind(logsController)
);
