...
export const UpdateProjectScheme = z.object({
	...
	buildCommand: z.string().regex(/^[a-zA-Z0-9_\-./ ]+$/, "Build command contains invalid characters").optional(),
	installCommand: z.string().regex(/^[a-zA-Z0-9_\-./ ]+$/, "Install command contains invalid characters").optional(),
	rootDir: z
		.string()
		.trim()
		.min(1, "Root directory cannot be empty")
